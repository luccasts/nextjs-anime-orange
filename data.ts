...
export const Api = [
  {
    animes: [
...

      {
        ...
        details: { description: "Uma jovem sacerdotisa forma seu primeiro bando de aventureiros, mas eles imediatamente se metem em apuros. É então que o Goblin Slayer vem a seu resgate - um homem que dedica sua vida a exterminar todos os goblins, custe o que custar. E quando seus feitos começam a se espalhar, ninguém sabe o que pode acontecer depois...", eps: '13', category: [{id:'3', name:"acao"}, {id:'1', name:"fantasia"}, {id:'2', name:"aventura"}] }
      ...
      },
      {
        ...
        details: { description: `Sindrome da puberdade - experiências anormais que dizem ser causadas pela sensitividade e instabilidade comuns na adolescência. Este ano, Sakuta Azusagawa, um estudante do segundo ano de um colégio perto de Enoshima, conheceu várias garotas que estão sofrendo dessa "síndrome da puberdade." Como, por exemplo, uma garota-coelhinho que ele conheceu na biblioteca. Ela é Mai Sakurajima, uma atriz que deu uma pausa na carreira, e também sua veterana no colégio. Por algum motivo, ninguém mais consegue ver essa encantadora garota. Como será que ela ficou invisível?`, eps: "13", category: [{id:'4', name:"comedia"}, {id:'5', name:"romance"}, {id:'6' , name:"sobrenatural"}] }
      ...
      },
      {
        ...
        details: { description: "Yumeko Jabami aposta alto e quer ganhar todas na Academia Hyakkaou, uma escola onde os alunos são avaliados só por suas habilidades no jogo.", eps: "12", category: [{id:'8',name:"drama"}, {id:'7' , name:"suspense"}] }
      },
      {
        id: "6",
        ...
        details: { description: "A jovem deusa Ristarte não tem certeza se ela teve sorte ou não quando foi escolhida como a deusa encarregada de encontrar um herói para salvar Gaeabrande, um mundo de ranking S. Ela só convocou cinco heróis antes, e nunca para um mundo desta dificuldade. Ela decide convocar um herói japonês para ajudá-la, e eventualmente tropeça nas estatísticas de Seiya Ryuuguuin. Rista rapidamente o convoca, mas acontece que ela realmente deveria ter lido as letras miúdas - Seiya pode ser poderoso, mas ele também é excessivamente cauteloso...", eps: "12", category: [{id:'4', name:"comedia"}, {id:'9', name:"violencia"}, {id:'10',name:"conteudo-sexual"}] }
      },
    ],
  },
];
...
//   {
//     category: [
//       'Fantasia', 'Aventura', 'Ação', 'Comédia', 'Romance', 'Sobrenatural', 'Suspense', 'Drama',
//       'Violência',
//     ]
//   }
// ]