    ...
    animes: [
      {
        ...
        eps: [
        {id:"kimetsu1", ep: "1", duration: "24", url: "https://www.youtube.com/embed/VQGCKyvzIM4", img: "/images/animes/kimetsu-yaiba/t1ep1.jpg", date:"2024/09/03" }, 
        {id:"kimetsu2", ep: "2", duration: "24", url: "https://www.youtube.com/embed/VQGCKyvzIM4", img: "/images/animes/kimetsu-yaiba/t1ep2.jpg", date:"2024/09/04"}],
        carousel: { url: "http://localhost:3000/anime/1", img: "http://localhost:3000/images/animes/kimetsu-yaiba/poster.jpg" },
...

      {
        id: "2",
        title: "Goblin Slayer",
        eps: [{ ep: "11", duration: "24", url: "https://www.youtube.com/embed/7qnhoB_cHSg?si=9pwRzt2iRPav28Z_", img: "/images/animes/goblin-slayer/t1ep11.jpg" }],
        carousel: { url: "http://localhost:3000/anime/2", img: "/images/animes/goblin-slayer/poster.jpg" },
      ...
      },
      {
        ...
        eps: [{ ep: "1", duration: "24", img: "/images/animes/bunny-girl/t1ep1.webp", url: "https://www.youtube.com/embed/o0TZj_d3Yfg?si=QUm5xJtn-3vMWvtU" }],
        carousel: { url: "http://localhost:3000/anime/3", img: "/images/animes/bunny-girl/poster.png" },
      ...
      },
      {
        ...
        eps: [{ ep: "3", duration: "24", img: "/images/animes/kono-suba/t1ep3.jpg", url: "https://www.youtube.com/embed/N1AO7k2o78g?si=RR4AQ5p5mcCd9qqB" }],
        carousel: { url: "http://localhost:3000/anime/4", img: "/images/animes/kono-suba/poster.jpg" },
      ...
      },
      {
        id: "5",
        title: "Kakegurui",
        eps: [{ ep: "5", duration: "24", img: "/images/animes/kakegurui/t1ep5.png", url: "https://www.youtube.com/embed/cTlHQiRNVl0?si=kaELsB2NKEyYRjK3" }],
        carousel: { url: "http://localhost:3000/anime/5", img: "/images/animes/kakegurui/poster.jpg" },
